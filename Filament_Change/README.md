...
### ⚠️ PLA 소재가 아닌 ABS 혹은 TPU 소재를 사용하실 경우 기술부에 승인 후 사용해주세요
ABS 소재를 사용하여 출력 시 발암물질이 발생하여 기술부에 승인받고 사용해 주세요
TPU 소재를 사용하여 출력할 때는 일부 설정이 변경되고 필라멘트 제거 시 추가적인 행동이 필요하기에 기술부에 승인받고 사용해 주세요
